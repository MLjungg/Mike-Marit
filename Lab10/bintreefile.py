...
class Bintree:
    ...
    def __contains__(self,value):
        if self.root != None: #Om det finns något i trädet
            if self.finns(value,self.root): #Om funktionen_finns retunerar true ska contains returnera true
                return True
            else:
                return False
        else:
    ...
    def finns(self, value, node):
        if value == node.value: #Om noden och sökta värdet är samma returnera true
            ...
            return self.finns(value, node.left) #Rekursivt. Sök till vänster
        elif value > node.value and node.right != None: # Om värdet är större än noden och det finns något till höger
            return self.finns(value, node.right) # Rekursivt. Sök till höger
        else:
            False
